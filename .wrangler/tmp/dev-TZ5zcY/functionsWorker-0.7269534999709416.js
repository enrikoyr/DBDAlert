...
// .wrangler/tmp/bundle-TcUg0W/checked-fetch.js
...
// ../.wrangler/tmp/pages-DAp6nd/functionsWorker-0.7269534999709416.mjs
...
async function onRequest(context) {
  ...
  try {
    ...
    for (const cls of classes) {
      ...
      const pRain = features.rainfall[cls][rainfallFeature] || 1e-6;
...
var KEYWORDS = ["kasus", "dbd", "demam berdarah", "banjir", "wabah", "nyamuk", "aedes", "fogging"];
var DISTRICTS = [
  "bengkayang",
  "kapuas hulu",
  "kayong utara",
...
function extractTags(xml, tag) {
  ...
  while ((match2 = regex.exec(xml)) !== null) {
    let content = match2[1].replace(/<!\[CDATA\[/g, "").replace(/\]\]>/g, "");
    matches.push(content);
  }
  return matches;
}
__name(extractTags, "extractTags");
__name2(extractTags, "extractTags");
async function onRequest2(context) {
  ...
  try {
    ...
    for (const item of items) {
      ...
      const timeDiffHours = (now.getTime() - pubDate.getTime()) / (1e3 * 60 * 60);
      if (timeDiffHours > 48) {
        continue;
      }
...
// .wrangler/tmp/bundle-TcUg0W/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-TcUg0W/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7269534999709416.js.map
